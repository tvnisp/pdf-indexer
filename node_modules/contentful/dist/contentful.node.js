...
function createClient(params) {
  ...
  const userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["getUserAgentHeader"])(`contentful.js/${"9.1.28"}`, config.application, config.integration);
